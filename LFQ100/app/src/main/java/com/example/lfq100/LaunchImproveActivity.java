...
import com.example.lfq100.adapter.LaunchImproveAdapter;

public class LaunchImproveActivity extends AppCompatActivity {
    // 声明引导页面的图片数组
    private int[] lanuchImageArray = {R.drawable.lyq,
            R.drawable.sb, R.drawable.ej, R.drawable.djy
